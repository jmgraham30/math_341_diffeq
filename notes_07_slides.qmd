...
**Step 1:** Substitute ICs into (3.7):
$$\bigl[s^2X - s\cdot\underbrace{0}_{x(0)} - \underbrace{1}_{x'(0)}\bigr] - 2\bigl[sX - \underbrace{0}_{x(0)}\bigr] + 2X = 0 \;\Longrightarrow\; (s^2-2s+2)X = 1$$
