...
:::: {.columns}
::: {.column width="58%"}
1. **Derivative formulas** (Theorem 3.11) and how to use them

2. **The three-step method** for IVPs

3. **Partial fractions** for all three pole types

4. **Completing the square** for complex poles

5. **Piecewise forcing** — Heaviside step approach
