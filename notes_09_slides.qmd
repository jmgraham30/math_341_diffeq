...
::: {.callout-important}
## $AB \neq BA$ in General — Concrete Counterexample
$$A = \begin{pmatrix}1&1\\0&0\end{pmatrix}, \quad B = \begin{pmatrix}0&0\\1&1\end{pmatrix}$$
$$AB = \begin{pmatrix}1&1\\0&0\end{pmatrix}\begin{pmatrix}0&0\\1&1\end{pmatrix} = \begin{pmatrix}1&1\\0&0\end{pmatrix} = A$$
$$BA = \begin{pmatrix}0&0\\1&1\end{pmatrix}\begin{pmatrix}1&1\\0&0\end{pmatrix} = \begin{pmatrix}0&0\\1&1\end{pmatrix} = B$$
Since $A \neq B$, we have $AB \neq BA$. Order matters — always write products carefully.
:::
...
# Non-commutativity: same matrices from the callout above
Anc = sym.Matrix([[1,1],[0,0]]); Bnc = sym.Matrix([[0,0],[1,1]])
print("\n=== Non-commutativity check ===")
print("AB =", (Anc*Bnc).tolist())
print("BA =", (Bnc*Anc).tolist())
print("AB == BA?", Anc*Bnc == Bnc*Anc)
```
