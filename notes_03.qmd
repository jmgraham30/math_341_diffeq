...
The linearization criterion is just an algebraic restatement of the phase line criterion:
...
#| code-summary: "Show the code"
#| label: fig-nonhyp
#| fig-cap: "Non-hyperbolic equilibrium $x'=x^3$ at $x^*=0$. The linearization $f'(0)=0$ is inconclusive. The full phase line reveals semi-stability: solutions above $x^*=0$ move away, solutions below approach."
...
A classical ecological bifurcation occurs in the **[spruce budworm model](https://en.wikipedia.org/wiki/Spruce_budworm)**, proposed by Ludwig, Jones, and Holling (1978).  The dimensionless form is:
$$
