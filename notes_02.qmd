...
::: {.callout-note}
This material corresponds to **Sections 1.1.3, 1.3, and 1.4** of [@logan2015first].  Section 1.2 (antiderivatives as a special case of exact equations) is **not covered**; we treat separable equations directly via separation of variables in the section below.
:::
