...
* **Office Hours for Students:** Students are welcome and encouraged to visit my office with no appointment required on Tuesdays 10:00--11:00am and Wednesdays and Fridays 10:30--11:30am. You may also make an appointment via email to meet with me outside of these scheduled student office hours.  
...
* **Course Page:** [https://math341diffeq.netlify.app/](https://math341diffeq.netlify.app/) contains link to syllabus, course materials, and other resources. Source code available at [https://github.com/jmgraham30/math_341_diffeq](https://github.com/jmgraham30/math_341_diffeq). **Also make sure to regularly check the course learning management system for announcements, assignments, and other course information.**
...
* [Notes](https://math341diffeq.netlify.app/notes) for the course are available on the course page both in long form and as slide decks. The slide decks will also be posted on the course learning management system. These notes are meant to be a supplement to the textbook and lectures, not a replacement. They are not necessarily comprehensive and may not contain all of the material covered in lecture or in the textbook. They are meant to be a resource for students to use in addition to attending lectures and reading the textbook.
...
The prerequisite for this course is MATH 222 *Calculus III*. Implicit in this is that students enrolled in the course should also have a mastery of Calculus I and II. In particular, students should be proficient in computing limits, derivatives, and integrals using techniques including but not limited to u-substitution, integration by parts, partial fractions, and trigonometric substitution. A solid grasp of Taylor series is also beneficial. Students should be able to independently look up or review calculus techniques when necessary. An online review of calculus techniques is available through the course page [at this link](https://math341diffeq.netlify.app/calc_review).

### Course Philosophy 

Differential equations are one of the most powerful ideas in all of mathematics, and one of the most useful. A differential equation is, at its core, a precise mathematical description of how something changes, and change is the central feature of almost every phenomenon worth studying: a current building in a circuit, a population growing toward its carrying capacity, a mass oscillating on a spring, a drug concentration falling in the bloodstream. This course takes both sides of that statement seriously. We will develop the fundamental concepts carefully, *e.g.*, understanding what a solution is and what techniques allow us to find them. And we will pursue applications earnestly, *e.g.*, in mechanics, electrical engineering, biology, chemistry, and beyond because those applications are what give the theory its meaning. Whether you are here as a mathematics major, an engineering student, or someone from the sciences, you will find that the same equations govern phenomena in your field. The goal of this course is to help you see that, and to give you the analytical and computational tools to do something with it.
...
|---|---|
| Recognize and explain what is meant by a differential equation as a mathematical model. | Homework assignments, DE model project, and in-class written exams. |
| Interpret solutions to differential equations in context as a mathematical model arising from applications in science, engineering, or other fields. | Homework assignments, DE model project, and in-class written exams. |
| Recognize and solve basic first- and second-order linear differential equations and apply Laplace transform methods to solve differential equations. | Homework assignments and in-class written exams. |
| Analyze by a variety of methods---including graphical, qualitative, and numerical---linear and nonlinear systems of differential equations. | Homework assignments and in-class written exams. |
