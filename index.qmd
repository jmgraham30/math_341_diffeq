...
* **Office Hours for Students:** Students are welcome and encouraged to visit my office with no appointment required on Tuesdays 10:00--11:00am and Fridays 1:00--3:00pm. You may also make an appointment via email to meet with me outside of these scheduled student office hours.  
...
Students are permitted to collaborate on the homework assignments. Note that collaboration in this context means a roughly equal amount of contribution from all parties involved. Thus, asking another student to show you how to do a complete problem is not collaboration and constitutes copying the work of someone else, which is academic dishonesty. On submitted homework, please identify for each problem who you worked with. Looking up solutions to homework problems online is academic dishonesty. Of course, all students are always welcome and encouraged to seek out help from the course instructor for solving homework problems.
