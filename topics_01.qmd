...
These ideas are standard tools in applied mathematics, physics, and engineering, and they appear throughout the analysis of ODEs.  Good introductory references are @logan2015first (Section 1.2), @strogatz2018nonlinear (Section 3.5), and the Wikipedia article on [nondimensionalization](https://en.wikipedia.org/wiki/Nondimensionalization).
