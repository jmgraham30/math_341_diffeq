...
# IVP: x(1)=0, x'(1)=0
# x(1):  e*(C1 + C2 - 1) = 0  =>  C1 + C2 = 1
# x'(1): e*(C2)          = 0  =>  C2 = 0, C1 = 1
C1_2, C2_2 = 1.0, 0.0
xp2  = t_plot2 * np.exp(t_plot2) * (np.log(t_plot2) - 1)
xh2  = C1_2*np.exp(t_plot2) + C2_2*t_plot2*np.exp(t_plot2)   # e^t
x2_full = xh2 + xp2
...
coefficients $t^2$ and $-2t$ are functions of $t$, not constants.  The
