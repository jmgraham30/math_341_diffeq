...
For a first-order ODE $x' = f(t, x)$, at every allowable point $(t, x)$ in the plane the ODE prescribes the **slope** that any solution curve through that point must have.
